...
export default function () {
  ...
  //
  Projects.insert({ projectNumber: "16202", projectName: "Lowe's SW Mississauga (Sheridan Centre)", tasks: LowesTasks });
  Projects.insert({ projectNumber: "16203", projectName: "Lowe's Barrhaven #2", tasks: LowesTasks });
